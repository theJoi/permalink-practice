...
<!--<hr />--> 
<!--<div class="clearfix padding-bleed"><img alt="" title="" src="/images/ip-series/vme-monitors.jpg" width="100%" />
</div>-->
<!--<div class="cta-bar clearfix">
	<div>
		<h2>NewTek IP Series Ecosystem</h2><a href="#" target="_blank" class="cta">Learn More</a>
	</div>
</div>-->
